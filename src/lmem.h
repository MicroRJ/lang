...
LAPI ALLOCFN(langM_deftlsallocfn);
LAPI ALLOCFN(langM_defgloballocfn);
...
lglobal Alloc elTempAllocator = {"default-temp-allocator",langM_deftlsallocfn};
lglobal Alloc elHeapAllocator = {"default-heap-allocator",langM_defgloballocfn};


#define elTEMP (&elTempAllocator)
#define elHEAP (&elHeapAllocator)
