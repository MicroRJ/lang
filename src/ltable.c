...
**
*/
llong langH_hashin(Table *table, lValue k) {
...
lValue langH_slot2value(Table *table, llong slot) {
...
void langH_slotsetkeyval(Table *table, llong slot, lValue k, llong i) {
...
llong langH_iadd(Table *table, lValue v) {
