...
#else
#define elf_log(TYPE,FORMAT,...) (0)
#define elf_loginfo(yyy,...) (0)
#define elf_logdebug(yyy,...) (0)
#define elf_logwarning(yyy,...) (0)
#define elf_logerror(yyy,...) (0)
#define elf_logfatal(yyy,...) (0)
#endif
